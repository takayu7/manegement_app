...
export const SaleDialog: React.FC<EditDialogProps> = ({ product, onSave }) => {
  ...
  return (
    <dialog id="SaleDialog" className="modal md:p-5">
          ...
          <li className="flex items-center flex-col md:flex-row md:justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                onClick={() => setEditProduct({ ...editProduct, count: stock })}
              >
                reset
              </button>
            </div>
